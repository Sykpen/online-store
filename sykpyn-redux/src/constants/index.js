...
export const SHOW_PRODUCT_CHANGE_MODAL = "SHOW_PRODUCT_CHANGE_MODAL";
export const CLOSE_PRODUCT_CHANGE_MODAL = "CLOSE_PRODUCT_CHANGE_MODAL";
export const SET_CURRENT_CLIENT_ORDERS = "SET_CURRENT_CLIENT_ORDERS";
